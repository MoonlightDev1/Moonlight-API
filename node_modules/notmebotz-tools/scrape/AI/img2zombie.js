...
async function i2z(imgUrl) {
	const jpegBuffer = await img2anime(imgUrl, {
		prompt: "Make tye body and face look a like a zombie and look a like zombie from train to busan, real art",
		negative_prompt: "blurry, deformed hands, 3d render, text, error image, random image color, error color",
		strength: 0.8,
	});
