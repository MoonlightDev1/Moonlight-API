...
const ApiKey = "Moonlight";
const criadora = "Moonlight_Devs"

//FUNÇÕES
async function uploadUrlCat(url) {
const userhash = null;
  try {
    ...
    console.error("Erro no uploadUrlCat:", error);
    throw error;
  }
}
//========[ DOWNLOAD ]========//
...
try {
api = await fetch(`${BaseApi}/api/download/audiomeme?nome=${query}&apikey=${ApiKey}`)
data = await api.json()
return {
status: "online",
criadora,
...
try {
api = await fetch(`${BaseApi}/api/pesquisas/apkpure?query=${query}&apikey=Moonlight`)
data = await api.json()
return {
status: "online",
criadora,
...
try {
api = await fetch(`${BaseApi}/api/pesquisa/pinterest?query=${query}&apikey=${ApiKey}`)
data = await api.json()
return {
status: "online",
criadora,
...
try {
api = await fetch(`${BaseApi}/api/pesquisa/wallpaper?query=${query}&apikey=${ApiKey}`)
data = await api.json()
return {
status: "online",
criadora,
...
try {
api = await fetch(`${BaseApi}/api/pesquisa/playstore?query=${query}&apikey=${ApiKey}`)
data = await api.json()
return {
status: "online",
criadora,
...
try {
if (name === "logo") {
api = `https://junimk.sirv.com/Api/1aa3ad239228f7cfe1cfb0b077cccfc4.jpg?text.0.text=${query}&text.0.position.gravity=center&text.0.position.y=20%25&text.0.size=90&text.0.color=ffffff&text.0.font.family=Courgette&text.0.background.color=ff2424&text.0.outline.color=5b4bde&text.0.outline.width=4&text.0.outline.blur=21`
return api;
} else if (name === "logo2") {
api = `https://junimk.sirv.com/Api/b5dc33dbe3e6baa7f7a64121c6f5a6c2.jpg?text.0.text=${query}&text.0.position.gravity=center&text.0.position.y=20%25&text.0.size=100&text.0.color=ffffff&text.0.font.family=Damion&text.0.background.color=ff2424&text.0.outline.color=de4b4b&text.0.outline.width=4&text.0.outline.blur=21`
return api;
} else if (name === "logo3") {
api = `https://junimk.sirv.com/Api/be4f071e8a558cf09eec6b4b9d63fe29.jpg?text.0.text=${query}&text.0.position.gravity=center&text.0.position.y=30%25&text.0.size=100&text.0.color=000000&text.0.font.family=Damion&text.0.background.color=ff2424&text.0.outline.color=ffffff&text.0.outline.width=4&text.0.outline.blur=21`
return api;
} else if (name === "logo4") {
api = `https://junimk.sirv.com/Api/9a8987ff1eb624256f8e86271f443545.jpg?text.0.text=${query}&text.0.position.gravity=center&text.0.position.y=30%25&text.0.size=100&text.0.color=ffffff&text.0.font.family=Damion&text.0.background.color=ff2424&text.0.outline.color=0026ff&text.0.outline.width=4&text.0.outline.blur=27`
return api;
} else if (name === "logo5") {
api = `https://junimk.sirv.com/Api/fe4b9803e07ab839efd4ef500b9456b9.jpg?text.0.text=${query}&text.0.position.gravity=center&text.0.position.y=30%25&text.0.size=100&text.0.color=ffffff&text.0.font.family=Damion&text.0.background.color=ff2424&text.0.outline.color=0026ff&text.0.outline.width=4&text.0.outline.blur=27`
return api;
}
} catch (e) {
console.log("Deu erro na solicitação, modulo: Scraper.js")
